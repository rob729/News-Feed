...
fun Toolbar(
    ...
    Surface(tonalElevation = toolbarElevation, color = MaterialTheme.colorScheme.surfaceVariant) {
        ConstraintLayout(
            modifier =
                modifier
                    .fillMaxWidth()
            ...
            val (
                titleConstraint, leftIconConstraint, titleSuffixImageConstraint,
                rightIcon1Constraint, rightIcon2Constraint, overflowMenuContentConstraint,
            ) = createRefs()
            leftIcon?.let {
                Icon(
                    imageVector = it.icon,
            ...
            rightIcon2?.let {
                IconButton(
                    ...
                    onClick = it.clickAction,
                ) {
                    Icon(
                        imageVector = it.icon,
                        contentDescription = "right_icon_2",
                        tint = Color.White,
                    )
                }
            }
